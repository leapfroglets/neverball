...
set shortmess=aoO
badd +1 index.html
badd +7 css/style.css
badd +1 js/game.js
badd +1 js/neverball.js
badd +1 js/3d.js
badd +37 js/math.js
badd +1 js/cube.js
badd +1 js/screen.js
...
badd +1 js/sphere.js
badd +1 js/coin.js
badd +2 js/levelmanager.js
badd +270 js/editor.js
badd +1 level_editor.html
badd +87 css/leveleditor.css
argglobal
silent! argdel *
$argadd index.html
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 321 - ((8 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
321
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 68 - ((36 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
normal! 013|
tabedit js/editor.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 306 - ((0 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
306
normal! 024|
tabedit js/levelmanager.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 101 - ((39 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
101
